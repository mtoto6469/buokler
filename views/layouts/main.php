...
<!--                            <h3>مدیر</h3>-->
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-female"></i>دسته بندی صفحه اصلی<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?=$url->createAbsoluteUrl('catpro/create')?>">ثبت دسته جدید</a></li>
                                        <li><a href="<?=$url->createAbsoluteUrl('catpro/index')?>">مدیریت دسته ها</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a><i class="fa fa-group"></i>پیشنهاد محصول<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?=$url->createAbsoluteUrl('proposal/create')?>">ثبت محصول جدید</a></li>
                                        <li><a href="<?=$url->createAbsoluteUrl('proposal/index')?>">مدیریت پیشنهادات</a></li>
                                    </ul>
                                </li>
