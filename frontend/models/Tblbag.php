...
class Tblbag extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_user', 'id_pro', 'date', 'date_ir', 'price'], 'required'],
            [['id_user', 'id_pro', 'count', 'id_fac', 'enabel', 'enable_view', 'down_buy', 'id_all_post', 'id_discount', 'size'], 'integer'],
            [['date'], 'safe'],
            [['date_ir', 'color', 'price'], 'string', 'max' => 300],
        ];
    }
