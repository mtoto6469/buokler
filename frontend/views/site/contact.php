...
<div class="row" >
    <div class="col-sm-8" style="text-align: right!important;">
        ...
        if(isset($_SESSION['m'])){
            if($_SESSION['m']!=null){
                echo '<div class="alert alert-success text-center">'.$_SESSION['m'].'</div>';
            }
            $_SESSION['m']=null;
        }
        ?>
        ...
        <?php $form = ActiveForm::begin(); ?>
            <div class="status alert alert-success" style="display: none"></div>
                ...
                <div class="form-group col-md-12" >
                    <?= \yii\helpers\Html::submitButton('ارسال پیام', ['class' => 'btn btn-primary' ,'style'=>'width:150px;float:left;padding:10px']) ?>
