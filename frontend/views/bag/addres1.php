            ...
            <table class="table table-condensed">
               ...
               <?php foreach ($bag as $b){
                   ...
                   $color_img=\frontend\models\Tblcolor::find()->where(['id_pro'=>$product->id])->andWhere(['color'=>$b->color])->one();
                    $size=Tblsize::find()->where(['id'=>$b->size])->one();
                   ?>
                   <tr>
...
//                               if($product->pak!=null){
//
//                                   $price=($size->price_namayande * $countsize)-$product->pak;
//
//                               }else{
//                                   $price=$size->price_namayande * $countsize;
//                               }
//
//                           }else{
//
...
//
//                               } else {
//                                   $price=$size->price_namayande;
//                               }
//
//                           }
//                           ?>
                           <p><?=$size->size.'رنگ '.$b->color?></p>
                       </td>
<!--                       <td class="cart_price">-->
<!--                           <p>--><?//=$price?><!--</p>-->
<!--                       </td>-->
