        ...
        <div class="col-sm-9 padding-right">
            ...
            <div class="col-sm-5">
							<div class="view-product">
								        <a href="">
            <img src="<?=Yii::$app->request->hostInfo?>/upload/<?=$product->img?>"  alt="">
        </a>
...
<!--                        <img src="images/product-details/new.jpg" class="newarrival" alt="">-->
                        ...
                        <div class="alert"  style="background:gold;text-align: center"><?=$exist?></div>
                        ...
                        <img src="images/product-details/rating.png" alt="">
								<span>
                                        ...
                                        if($product->takhfif!=null){
                                            ?>
                                            <s class="b"> قیمت <?=$product->price?>ریال </s><br>
                                            <span> قیمت <?=$product->takhfif?>ریال </span><br>
                                            <?php
                                        }else{?>
                                        <span> قیمت <?=$product->price?>ریال </span><br>
                                    <?php
                                        }
