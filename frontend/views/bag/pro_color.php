...
if ($count >= 1) {
    ...
    <section id="advertisement">
        <div class="container">
            <div class=""
                 style="background-color: orange;box-shadow: 10px 10px 5px grey;height: 100px;text-align: center">
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center" style="height:350px!important;">
                                        <img src="<?= Yii::$app->request->hostInfo ?>/upload/<?= $c->img ?>" width="60%"
                                             height="55%" alt="">
                                        ...
                                        echo '<br>';
                                        ?>
                                        <a href="<?= $url->createAbsoluteUrl(['bag/details', 'id' => $product->id, 'color' => $c->color]) ?>"
                                           class="btn btn-default add-to-cart"><i class="fa fa-user"></i>جزئیات</a>
                                    </div>
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                            ...
                                            echo '<br>';
                                            //                                            ?>
                                            <a href="<?= $url->createAbsoluteUrl(['bag/details', 'id' => $product->id, 'color' => $c->color ,'size_id'=>$size_asli]) ?>"
                                               class="btn btn-default add-to-cart"><i class="fa fa-user"></i>جزئیات</a>
                                        </div>
                                    </div>
                                </div>
